      ...
      <div className="p-6 max-w-3xl mx-auto">
        <div className="bg-white border border-gray-200 rounded-3xl shadow-sm overflow-hidden">
          <div className="p-4 border-b flex items-center justify-between gap-2">
            <div className="font-black text-gray-900">حدث خطأ</div>
            <Link href="/reports" className="text-xs font-black text-blue-700 hover:underline">رجوع</Link>
          </div>
          <div className="p-4 space-y-3">
            <div className="text-sm font-bold text-gray-900">تعذر تحميل تقرير الإيرادات</div>
            <div className="text-xs text-gray-600">حدث خطأ غير متوقع أثناء معالجة البيانات.</div>
            <div className="bg-gray-900 text-white rounded-2xl p-3 text-[11px] font-mono overflow-auto">
              TypeError: Cannot read properties of undefined (reading 'total'){"\n"}
              at RevenueReportPage (reports/revenue/page.tsx){"\n"}
              at renderWithHooks (react-dom){"\n"}
              at commitRoot (react-dom)
            </div>
            <div className="flex items-center justify-end">
              <Link href="/reports" className="px-4 py-2 rounded-2xl bg-gray-900 text-white font-black text-sm hover:bg-gray-800">
                رجوع للتقارير
              </Link>
            </div>
          </div>
